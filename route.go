...
var route = []webapi.Route{
    ...
    {"GET", "/apps/list", appsApp.List, "", []context.IFilter{application.Jwt{}}, []string{"", "", "", ""}},
    {"GET", "/apps/syslist", appsApp.SysList, "", []context.IFilter{application.Jwt{}}, []string{"", "", "", ""}},
    ...
    {"POST", "/apps/build/add", appsApp.BuildAdd, "", []context.IFilter{}, []string{"request", "", "", ""}},
    ...
    {"GET", "/apps/build/viewIncremental-{buildId}-{fromLine}", appsApp.ViewIncremental, "", []context.IFilter{}, []string{"buildId", "fromLine"}},
    {"POST", "/apps/build/stop", appsApp.Stop, "", []context.IFilter{application.Jwt{}}, []string{"buildId", "buildType", ""}},
    {"POST", "/apps/build/branchList", appsApp.BranchList, "", []context.IFilter{application.Jwt{}}, []string{"appName", ""}},
    {"POST", "/apps/build/appFrameworkList", appsApp.AppFrameworkList, "", []context.IFilter{application.Jwt{}}, []string{"appName", ""}},
    {"POST", "/apps/build/manifestList", appsApp.ManifestList, "", []context.IFilter{application.Jwt{}}, []string{"appName", ""}},
    {"POST", "/apps/build/manifestDetail", appsApp.ManifestDetail, "", []context.IFilter{application.Jwt{}}, []string{"dockerImage", ""}},
    {"POST", "/apps/build/remoteBranchList", appsApp.GitRemoteBranchList, "", []context.IFilter{application.Jwt{}}, []string{"gitId", "", ""}},
    {"GET", "/apps/config/config/get", appsApp.GetConfig, "", []context.IFilter{application.Jwt{}}, []string{"appName", ""}},
    {"POST", "/apps/config/config/save", appsApp.SaveConfig, "", []context.IFilter{application.Jwt{}}, []string{"appName", "content", ""}},
    ...
    {"POST", "/terminal/clientDel", terminalApp.ClientDel, "", []context.IFilter{application.Jwt{}}, []string{"loginIp", ""}},
    {"POST", "/terminal/clientInfo", terminalApp.ClientInfo, "", []context.IFilter{application.Jwt{}}, []string{"loginIp", ""}},
