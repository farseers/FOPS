...
var route = []webapi.Route{
	...
	{"POST", "/build/syncDockerImage", appsApp.SyncDockerImage, "", []context.IFilter{application.Jwt{}}, []string{"clusterId", "appName", "", "", ""}},
	{"POST", "/deleteService", appsApp.DeleteService, "", []context.IFilter{application.Jwt{}}, []string{"appName", "", ""}},
	{"POST", "/updateDockerImage", appsApp.UpdateDockerImage, "", []context.IFilter{}, []string{"appName", "dockerImage", "buildNumber", "clusterId", "dockerHub", "dockerUserName", "dockerUserPwd", "", "", "", ""}},
	{"POST", "/build/clearDockerImage", appsApp.ClearDockerImage, "", []context.IFilter{application.Jwt{}}, []string{""}},
	{"POST", "/build/restartDocker", appsApp.RestartDocker, "", []context.IFilter{application.Jwt{}}, []string{"clusterId", "appName", "", ""}},
