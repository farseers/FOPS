...
var route = []webapi.Route{
    ...
    {"POST", "/apps/build/add", appsApp.BuildAdd, "", []context.IFilter{application.Jwt{}}, []string{"appName", "workflowsName", "", "", ""}},
    ...
    {"POST", "/monitor/noticeLogNoReadList", monitorApp.ToListPageNoticeLogNoRead, "", []context.IFilter{application.Jwt{}}, []string{""}},
    {"POST", "/monitor/allRead", monitorApp.UpdateNoticeLogRead, "", []context.IFilter{application.Jwt{}}, []string{""}},
