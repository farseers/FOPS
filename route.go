...
var route = []webapi.Route{
    ...
    {"POST", "/apps/appFrameworkList", appsApp.AppFrameworkList, "", []context.IFilter{application.Jwt{}}, []string{"appName", ""}},
    ...
    {"POST", "/apps/build/add", appsApp.BuildAdd, "", []context.IFilter{}, []string{"appName", "workflowsName", "branchName", "updateFramework", "", "", ""}},
    ...
    {"POST", "/apps/build/manifest-list", appsApp.ManifestList, "", []context.IFilter{application.Jwt{}}, []string{"appName", ""}},
    {"POST", "/apps/build/manifest-detail", appsApp.ManifestDetail, "", []context.IFilter{application.Jwt{}}, []string{"dockerImage", ""}},
