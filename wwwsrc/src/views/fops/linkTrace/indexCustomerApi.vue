  ...
  <div class="system-user-container layout-padding">
    <el-card shadow="hover" class="layout-padding-auto">
      <div class="system-user-search mb15">
        ...
        <el-input class="ml5" size="default" v-model="state.server" placeholder="MQ服务端" clearable
      ...
      <el-table :data="state.tableData.data" v-loading="state.tableData.loading" style="width: 100%">
        ...
        <el-table-column label="队列名称" show-overflow-tooltip>
          <template #default="scope">
            ...
            <el-tag v-if="scope.row.ConsumerRoutingKey != ''" size="small">{{ scope.row.ConsumerRoutingKey }}</el-tag><br v-if="scope.row.ConsumerRoutingKey != ''" />
...
const linkTraceDelete = () => {
  ElMessageBox.confirm(`删除七天前的数据，是否继续?`, '提示', {
    ...
    .then(() => {
      serverApi.linkTraceDelete({ traceType: 1 }).then((res) => {
        if (res.Status) {
          onQuery();
