<template>
	<div class="system-user-container layout-padding">
        ...
        <el-input class="ml5" size="default" v-model="state.dbName" placeholder="数据库名称" clearable style="max-width: 180px;"> </el-input>
        <label class="ml10">表名称</label>
        <el-input class="ml5" size="default" v-model="state.tableName" placeholder="表名称" clearable style="max-width: 180px;"> </el-input>
