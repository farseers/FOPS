<template>
	<div class="system-user-container layout-padding">
        ...
        <el-input class="ml5" size="default" v-model="state.key" placeholder="Key" style="max-width: 180px;"> </el-input>
        <label class="ml10">Field</label>
        <el-input class="ml5" size="default" v-model="state.field" placeholder="Field" style="max-width: 180px;"> </el-input>
