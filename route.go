...
var route = []webapi.Route{
	...
	{"POST", "/apps/dropDownList", appsApp.DropDownList, "", []context.IFilter{application.Jwt{}}, []string{""}},
	{"POST", "/apps/list", appsApp.List, "", []context.IFilter{application.Jwt{}}, []string{"clusterId", "isSys", "", "", "", ""}},
	{"POST", "/apps/info", appsApp.Info, "", []context.IFilter{application.Jwt{}}, []string{"clusterId", "appName", ""}},
	...
	{"POST", "/apps/restartDocker", appsApp.RestartDocker, "", []context.IFilter{application.Jwt{}}, []string{"clusterId", "appName", "", ""}},
