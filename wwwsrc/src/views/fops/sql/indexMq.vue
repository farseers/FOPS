<template>
	<div class="system-user-container layout-padding">
        ...
        <el-input class="ml5" size="default" v-model="state.server" placeholder="服务地址" clearable style="max-width: 180px;"> </el-input>
        <label class="ml10">交换器</label>
        <el-input class="ml5" size="default" v-model="state.exchange" placeholder="交换器" clearable style="max-width: 180px;"> </el-input>
