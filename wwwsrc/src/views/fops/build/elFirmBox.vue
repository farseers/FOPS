  ...
  <div>
    <el-dialog title="提示" v-model="state.isShowDialog" width="400px">
      <div class="cropper-warp">
        <div style="margin-bottom: 5px;">请填写分支名称!</div>
        <el-autocomplete v-if="state.isShowDialog" class="inline-input" style="width: 100%;" ref="autoCompleteRef"
          clearable v-model="state.inputValue" :fetch-suggestions="querySearch" placeholder="请输入分支名称"
          :trigger-on-focus="true" @select="handleSelect" @keyup.enter.native="onSubmit"></el-autocomplete>
          <el-checkbox v-model="state.updateFramework" style="margin-bottom: 5px;">使用最新的框架版本</el-checkbox>
      </div>
      <template #footer>
