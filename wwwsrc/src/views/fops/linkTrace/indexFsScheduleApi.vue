  ...
  <div class="system-user-container layout-padding">
    <el-card shadow="hover" class="layout-padding-auto">
      <div class="system-user-search mb15">
        ...
        <el-input class="ml5" size="default" v-model="state.taskName" placeholder="任务名称" clearable
          style="max-width: 180px;"> </el-input>
        <label class="ml10">任务组ID</label>
        <el-input class="ml5" size="default" v-model="state.taskGroupId" placeholder="任务组ID" clearable
          style="max-width: 90px;"> </el-input>
        <label class="ml10">任务ID</label>
        <el-input class="ml5" size="default" v-model="state.taskId" placeholder="任务ID" clearable
          style="max-width: 180px;"> </el-input>
      ...
      <el-table :data="state.tableData.data" v-loading="state.tableData.loading" style="width: 100%">
        ...
        <el-table-column label="任务名称" show-overflow-tooltip>
          <template #default="scope">
            <el-tag v-if="scope.row.TaskGroupName != ''" size="small">任务组：{{ scope.row.TaskGroupName }}</el-tag>
            <el-tag v-if="scope.row.TaskId > 0" size="small" type="success">任务Id：{{ scope.row.TaskId }}</el-tag>
            <br v-if="scope.row.TaskGroupName != '' || scope.row.TaskId > 0" />
            {{ scope.row.TaskName }}
          </template>
        </el-table-column>
