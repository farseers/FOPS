...
require (
	...
	github.com/farseer-go/data/driver/clickhouse v0.17.3
	github.com/farseer-go/docker v0.17.3
	github.com/farseer-go/elasticSearch v0.17.3
	github.com/farseer-go/eventBus v0.17.3
	github.com/farseer-go/fs v0.17.3
	github.com/farseer-go/mapper v0.17.3
	github.com/farseer-go/monitor v0.17.3
	github.com/farseer-go/queue v0.17.3
