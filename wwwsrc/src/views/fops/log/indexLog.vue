  ...
  <div class="system-user-container layout-padding">
    <el-card shadow="hover" class="layout-padding-auto">
      <div class="system-user-search mb15">
        <label>TraceId</label>
        <el-input size="default" v-model="state.traceId" placeholder="链路ID" clearable
          style="max-width: 180px;padding-left: 5px"> </el-input>
        ...
        <el-input size="default" v-model="state.logContent" placeholder="日志内容" clearable
          style="max-width: 250px;padding-left: 5px"> </el-input>
