  ...
  <div class="system-user-container layout-padding">
    <el-card shadow="hover" class="layout-padding-auto">
      <div class="system-user-search mb15">
        ...
        <el-date-picker class="ml5" size="default" v-model="state.startAt" type="datetime" :shortcuts="shortcuts"
          placeholder="开始时间" clearable style="width: 200px"></el-date-picker>
        <label class="ml10">结束时间</label>
        <el-date-picker class="ml5" size="default" v-model="state.endAt" type="datetime" :shortcuts="shortcuts"
          placeholder="结束时间" clearable style="width: 200px"></el-date-picker>
      ...
      <el-table :data="state.tableData.data" v-loading="state.tableData.loading" style="width: 100%"
        ...
        <el-table-column label="访问节点" show-overflow-tooltip>
          <template #default="scope">
            <el-tag size="small" v-if="scope.row.VisitsNode.endsWith('/')" @click="onVisitsNode(scope.row.VisitsNode)"
              style="font-size: 14px;cursor:pointer">{{ scope.row.VisitsNode }}</el-tag>
        ...
        <el-table-column width="140px" label="min" show-overflow-tooltip align="right">
          <template #default="scope">
            <el-tag size="small" v-if="scope.row.MinMs >= 1000" type="danger"
              style="font-size: 14px;">{{ scope.row.MinMs.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.MinMs >= 500" type="warning"
              style="font-size: 14px;">{{ scope.row.MinMs.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.MinMs >= 100"
              style="font-size: 14px;">{{ scope.row.MinMs.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.MinMs >= 50" type="success"
              style="font-size: 14px;">{{ scope.row.MinMs.toFixed(1) }}</el-tag>
        ...
        <el-table-column width="140px" label="max" show-overflow-tooltip align="right">
          <template #default="scope">
            <el-tag size="small" v-if="scope.row.MaxMs >= 1000" type="danger"
              style="font-size: 14px;">{{ scope.row.MaxMs.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.MaxMs >= 500" type="warning"
              style="font-size: 14px;">{{ scope.row.MaxMs.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.MaxMs >= 100"
              style="font-size: 14px;">{{ scope.row.MaxMs.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.MaxMs >= 50" type="success"
              style="font-size: 14px;">{{ scope.row.MaxMs.toFixed(1) }}</el-tag>
        ...
        <el-table-column width="140px" label="avg" show-overflow-tooltip align="right">
          <template #default="scope">
            <el-tag size="small" v-if="scope.row.AvgMs >= 1000" type="danger"
              style="font-size: 14px;">{{ scope.row.AvgMs.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.AvgMs >= 500" type="warning"
              style="font-size: 14px;">{{ scope.row.AvgMs.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.AvgMs >= 100"
              style="font-size: 14px;">{{ scope.row.AvgMs.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.AvgMs >= 50" type="success"
              style="font-size: 14px;">{{ scope.row.AvgMs.toFixed(1) }}</el-tag>
        ...
        <el-table-column width="140px" label="95line" show-overflow-tooltip align="right">
          <template #default="scope">
            <el-tag size="small" v-if="scope.row.Line95Ms >= 1000" type="danger"
              style="font-size: 14px;">{{ scope.row.Line95Ms.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.Line95Ms >= 500" type="warning"
              style="font-size: 14px;">{{ scope.row.Line95Ms.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.Line95Ms >= 100"
              style="font-size: 14px;">{{ scope.row.Line95Ms.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.Line95Ms >= 50" type="success"
              style="font-size: 14px;">{{ scope.row.Line95Ms.toFixed(1) }}</el-tag>
        ...
        <el-table-column width="140px" label="99line" show-overflow-tooltip align="right">
          <template #default="scope">
            <el-tag size="small" v-if="scope.row.Line99Ms >= 1000" type="danger"
              style="font-size: 14px;">{{ scope.row.Line99Ms.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.Line99Ms >= 500" type="warning"
              style="font-size: 14px;">{{ scope.row.Line99Ms.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.Line99Ms >= 100"
              style="font-size: 14px;">{{ scope.row.Line99Ms.toFixed(1) }}</el-tag>
            <el-tag size="small" v-else-if="scope.row.Line99Ms >= 50" type="success"
              style="font-size: 14px;">{{ scope.row.Line99Ms.toFixed(1) }}</el-tag>
        ...
        <el-table-column width="140px" label="错误量" show-overflow-tooltip align="right">
          <template #default="scope">
            <el-tag size="small" v-if="scope.row.ErrorCount >= 1" type="danger"
              style="font-size: 14px;">{{ scope.row.ErrorCount }}</el-tag>
            <el-tag size="small" v-else type="info" style="font-size: 14px;">{{ scope.row.ErrorCount }}</el-tag>
          </template>
        </el-table-column>
        <el-table-column width="100px" prop="TotalCount" label="访问次数" show-overflow-tooltip style="font-size: 14px;"
