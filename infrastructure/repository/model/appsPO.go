...
type AppsPO struct {
	...
	DockerVer         int                                    `gorm:"type:int;not null;default:0;comment:镜像版本"`
	...
	DockerInspect     collections.List[apps.DockerInspectVO] `gorm:"size:2048;json;not null;default:'{}';comment:运行的实例详情"`
