<template>
	<div class="system-user-container layout-padding">
        ...
        <el-input class="ml5" size="default" v-model="state.server" placeholder="服务地址" style="max-width: 180px;"> </el-input>
        <label class="ml10">交换器</label>
        <el-input class="ml5" size="default" v-model="state.exchange" placeholder="交换器" style="max-width: 180px;"> </el-input>
        <label class="ml10">路由KEY</label>
        <el-input class="ml5" size="default" v-model="state.routingKey" placeholder="路由KEY" style="max-width: 180px;"> </el-input>
