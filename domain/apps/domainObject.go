...
type DomainObject struct {
	...
	ClusterVer        collections.Dictionary[int, ClusterVerVO] // 集群版本
	AppGit            int64                                     // 应用的源代码
...
func (receiver *DomainObject) UpdateBuildVer(isSuccess bool, clusterId int, buildId int64, dockerVer int, dockerImage string) {
	if receiver.ClusterVer.IsNil() {
		receiver.ClusterVer = collections.NewDictionary[int, ClusterVerVO]()
	}
...
func (receiver *DomainObject) GetCurClusterDockerImage(clusterId int) string {
...
func (receiver *DomainObject) InitCluster(clusterId int) {
	if receiver.ClusterVer.IsNil() {
		receiver.ClusterVer = collections.NewDictionary[int, ClusterVerVO]()
	}
	if !receiver.ClusterVer.ContainsKey(clusterId) {
