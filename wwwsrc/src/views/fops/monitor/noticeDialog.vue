<template>
    <div class="system-role-dialog-container">
      ...
      :rules="rules">
            ...
            <el-form-item label="姓名" prop='Name'><el-input v-model="infoRow.Name" /></el-form-item>
            <el-form-item label="号码" prop='Phone'><el-input v-model="infoRow.Phone" /></el-form-item>
