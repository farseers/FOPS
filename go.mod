...
require (
	...
	github.com/farseer-go/docker v0.15.0
	github.com/farseer-go/elasticSearch v0.15.0
	github.com/farseer-go/eventBus v0.15.0
	github.com/farseer-go/fs v0.15.0
	github.com/farseer-go/linkTrace v0.15.0
