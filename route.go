...
var route = []webapi.Route{
    ...
    {"POST", "/backupData/deleteHistory", backupDataApp.DeleteBackupFile, "", []context.IFilter{application.Jwt{}}, []string{"backupId", "filePath", ""}},
    {"POST", "/backupData/recoverBackupFile", backupDataApp.RecoverBackupFile, "", []context.IFilter{application.Jwt{}}, []string{"backupId", "filePath", ""}},
